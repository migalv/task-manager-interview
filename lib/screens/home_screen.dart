              ...
              return PopupMenuButton<String>(
                ...
                itemBuilder: (context) => [
                  PopupMenuItem(
                    value: 'profile',
                    child: Text(
                      'Hello, ${_userManager.currentUser?.getUserDisplayName() ?? 'User'}',
                    ),
                  ),
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return TaskWidget(task: _tasks[index], onTaskUpdated: _loadTasks);
        },
      ),
    );
  }
  ...
  List<Task> _generateMockTasks() {
    ...
    return [
      Task(
        ...
        description:
            'Review the task manager code for SOLID principle violations and code quality issues.',
      ...
      Task(
        ...
        description:
            'Improve the user management code to follow SOLID principles and reduce code duplication.',
      ...
      Task(
        ...
        description:
            'Create a proper abstraction for the notification system to follow the Open/Closed principle.',
        status: TaskStatus.pending,
      ...
      Task(
        ...
        description:
            'Add comprehensive unit tests for all the business logic components.',
